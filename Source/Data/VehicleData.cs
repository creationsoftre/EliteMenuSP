    ...
    public static class VehicleData
    {
        public struct VehicleColor
        {
            ...
            public VehicleColor(int id, string label)
            {
                ...
                {
                    string taxiYellow = Function.Call<string>(Hash._GET_LABEL_TEXT, "veh_color_taxi_yellow");
                    if (taxiYellow == "NULL")
                    {
                        
                        //Function.Call<string>(Hash.,  Function.Call<string>(Hash._GET_LABEL_TEXT, "IEC_T20_2")); -- need to find function 
                        
                    }
                }
                else if (label == "veh_color_off_white")
                {
                    string offWhite = Function.Call<string>(Hash._GET_LABEL_TEXT, "veh_color_off_white");
                    if (offWhite == "NULL")
                    {
                        //Function.Call<string>(Hash._SET_TEXT_ENTRY, "Off White");
                    }
                }
                else if (label == "VERY_DARK_BLUE")
                {
                    string veryDarkBlue = Function.Call<string>(Hash._GET_LABEL_TEXT, "VERY_DARK_BLUE");
                    if (veryDarkBlue == "NULL")
                    {
                        //Function.Call<string>(Hash._SET_TEXT_ENTRY, "Very Dark Blue");
                    }
                }
